...
-- Sequences usadas por CompraRepositoryJdbc
CREATE SEQUENCE IF NOT EXISTS SEQ_COMPRA START WITH 1000 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS SEQ_PAGO   START WITH 2000 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS SEQ_BOLETO START WITH 3000 INCREMENT BY 1;
